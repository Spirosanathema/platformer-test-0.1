...
public class ParallaxLayer {
	 ...
	 public TextureRegion region ;
	     ...
	     * @param parallaxRatio   the relative speed of x,y {@link ParallaxBackground#
	     * 													ParallaxBackground(ParallaxLayer[], float, float, Vector2)}
	     * 													Spiros:The speed of x and y!!!
	     * @param startPosition the init position of x,y
	     * @param padding  the padding of the region at x,y => Spiros: From where (x and y) starts repeating rendering
	     */
